...
try {
    ...
    $request->userInput->country = 'Bhutan';
    $request->userInput->email = 'Waino_Orn@gmail.com';
    $request->userInput->firstname = 'Cecilia';
    $request->userInput->lastname = 'Ebert';
    $request->userInput->nickname = 'corporis';
    $request->userInput->password = 'explicabo';
