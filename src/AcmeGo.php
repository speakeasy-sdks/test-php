...
class AcmeGo
{
     ...
     * Create user
     * 
     * @param \vitor_test\Acme\Models\Shared\UserInput $request
     * @return \vitor_test\Acme\Models\Operations\CreateUserv1Response
     */
	public function createUserv1(
        \vitor_test\Acme\Models\Shared\UserInput $request,
    ): \vitor_test\Acme\Models\Operations\CreateUserv1Response
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->user = $serializer->deserialize((string)$httpResponse->getBody(), 'vitor_test\Acme\Models\Shared\User', 'json');
            }
        }
        else {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->error = $serializer->deserialize((string)$httpResponse->getBody(), 'vitor_test\Acme\Models\Shared\Error', 'json');
            }
        }
    ...
    ): \vitor_test\Acme\Models\Operations\DeleteUserv1Response
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->success = $serializer->deserialize((string)$httpResponse->getBody(), 'vitor_test\Acme\Models\Shared\Success', 'json');
            }
        }
        else {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * Search users
     * 
     * @param \vitor_test\Acme\Models\Shared\Filters $request
     * @return \vitor_test\Acme\Models\Operations\SearchUsersv1Response
     */
	public function searchUsersv1(
        \vitor_test\Acme\Models\Shared\Filters $request,
    ): \vitor_test\Acme\Models\Operations\SearchUsersv1Response
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->users = $serializer->deserialize((string)$httpResponse->getBody(), 'vitor_test\Acme\Models\Shared\Users', 'json');
            }
        }
